...
public class TankShooting1 : MonoBehaviour
{
    ...
    void Update()
    {
        // Kiểm tra nếu nhấn phím J và đủ thời gian để bắn tiếp
    ...
    private IEnumerator FireLaser()
    {
        ...
        if (Physics.Raycast(firePoint.position, firePoint.forward, out hit, range))
        {
            ...
            if (hit.collider.CompareTag("Player2")) // Tag của Player 2
            {
                GameManager2Player.Instance.TakeDamage(2, 10); // Trừ 10 máu Player 2
            }
        }
        else
        {
